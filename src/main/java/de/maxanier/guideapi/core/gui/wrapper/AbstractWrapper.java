...
public abstract class AbstractWrapper {
    ...
    public abstract void draw(GuiGraphicsExtractor graphics, int mouseX, int mouseY, GuideBookScreen gui);

    public abstract void drawExtras(GuiGraphicsExtractor graphics, int mouseX, int mouseY, GuideBookScreen gui);
